...
export const navigation: NavItem[] = [
  ...
  { to: "/trips", label: "Chuyến hàng", icon: PackageCheck, accent: "#4f8794", pastel: "#dff2f4" },
  { to: "/warehouses", label: "Quản lý kho", icon: Package, accent: "#7a8f45", pastel: "#eef5d8" },
  ...
  { to: "/drying", label: "Sấy lúa", icon: Flame, accent: "#c06848", pastel: "#fce4dc" },
  { to: "/processing-records", label: "Xay xát", icon: Landmark, accent: "#c07850", pastel: "#fce8dc" },
